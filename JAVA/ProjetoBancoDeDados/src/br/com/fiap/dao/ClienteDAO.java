...
public class ClienteDAO {
    ...
    public boolean alterar(Cliente cliente) {
        ...
        try {
            ...
            p.execute();
            status = true; // só chega nessa linha se o execute() acima não der problema 
        } catch (SQLException ex) {
    ...
    public boolean excluir(String cpf) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao exluir cliente");
        }
        return status;
    }
